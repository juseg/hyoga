...
"""
Plot Hokkaido topographic contour map.
"""
...
# add relief maps
csr.add_bathymetry_contours('external/cleantopo2.tif', offset=10701.0)
csr.add_multishade('external/cleantopo2.tif')
csr.add_topography_contours('external/srtm.tif', vmax=2250)
