...
def bedrock_altitude(ds, sealevel=0, **kwargs):
    ...
    **kwargs: optional
    ...
    style.update(kwargs)
    var = ds.hyoga.getvar('bedrock_altitude') - sealevel
    return var.plot.imshow(**style)


def bedrock_altitude_contours(ds, **kwargs):
...
def bedrock_erosion(ds, constant=5.2e-8, exponent=2.34, **kwargs):
    ...
    **kwargs: optional
    ...
    style.update(kwargs)
    var = ds.hyoga.getvar('magnitude_of_land_ice_basal_velocity')
    var = var.where(ds.hyoga.getvar('land_ice_area_fraction') >= 0.5)
...
def bedrock_isostasy(ds, **kwargs):
...
def bedrock_shoreline(ds, sealevel=0, **kwargs):
    """Plot bedrock topography and shoreline.
...
def ice_margin(ds, edgecolor='0.25', facecolor=None, **kwargs):
    ...
    **kwargs: optional
    ...
    """
    var = ds.hyoga.getvar('land_ice_area_fraction')
    contours = []
...
def surface_altitude_contours(ds, major=1000, minor=200, **kwargs):
    ...
    **kwargs: optional
    ...
    """
    var = ds.hyoga.getvar('surface_altitude')
    var = var.where(ds.hyoga.getvar('land_ice_area_fraction') >= 0.5)
...
def surface_velocity(ds, **kwargs):
    ...
    **kwargs: optional
    ...
    style.update(kwargs)
    var = ds.hyoga.getvar('magnitude_of_land_ice_surface_velocity')
    var = var.where(ds.hyoga.getvar('land_ice_area_fraction') >= 0.5)
    return var.plot.imshow(**style)


def surface_velocity_streamplot(ds, **kwargs):
    ...
    **kwargs: optional
    ...
    mask = ds.hyoga.getvar('land_ice_area_fraction') >= 0.5
    uvar = ds.hyoga.getvar('land_ice_surface_x_velocity').where(mask)
    vvar = ds.hyoga.getvar('land_ice_surface_y_velocity').where(mask)
...
class HyogaPlotMethods:
    ...
    @functools.wraps(bedrock_altitude)
    def bedrock_altitude(self, *args, **kwargs):
        return bedrock_altitude(self._ds, *args, **kwargs)

    @functools.wraps(bedrock_altitude_contours)
    def bedrock_altitude_contours(self, *args, **kwargs):
        return bedrock_altitude_contours(self._ds, *args, **kwargs)

    @functools.wraps(bedrock_erosion)
    def bedrock_erosion(self, *args, **kwargs):
        return bedrock_erosion(self._ds, *args, **kwargs)

    @functools.wraps(bedrock_hillshade)
    def bedrock_hillshade(self, *args, **kwargs):
        return bedrock_hillshade(self._ds, *args, **kwargs)

    @functools.wraps(bedrock_isostasy)
    def bedrock_isostasy(self, *args, **kwargs):
        return bedrock_isostasy(self._ds, *args, **kwargs)

    @functools.wraps(bedrock_shoreline)
    def bedrock_shoreline(self, *args, **kwargs):
        return bedrock_shoreline(self._ds, *args, **kwargs)

    @functools.wraps(ice_margin)
    def ice_margin(self, *args, **kwargs):
        return ice_margin(self._ds, *args, **kwargs)

    @functools.wraps(surface_altitude_contours)
    def surface_altitude_contours(self, *args, **kwargs):
        return surface_altitude_contours(self._ds, *args, **kwargs)

    @functools.wraps(surface_hillshade)
    def surface_hillshade(self, *args, **kwargs):
        return surface_hillshade(self._ds, *args, **kwargs)

    @functools.wraps(surface_velocity)
    def surface_velocity(self, *args, **kwargs):
        return surface_velocity(self._ds, *args, **kwargs)

    @functools.wraps(surface_velocity_streamplot)
    def surface_velocity_streamplot(self, *args, **kwargs):
        return surface_velocity_streamplot(self._ds, *args, **kwargs)
